        ...
        <div class="border-2 border-gray-200 px-10 py-4 ">
            ...
            if (!empty($order)) {
                ...
                echo '<h1 class=" text-center text-[30px] border border-slate-300 ...">Bạn chưa mua gì cả : 
                    <a class="text-center bg-green-500 rounded-md p-1 text-white font-bold text-[32px] border border-slate-300 ..." href="index.php?act=product " >Quay lại trang sản phẩm</a>
                    </h1>';
            }
            ?>
        </div>
