    ...
    <div class="ad-r">
        ...
        <div class="">
            ...
            <div class="flex items-center">
                ...
                <a href="index.php?act=list-cate" class="text-[20px] mx-4 font-semibold text-sky-600 ">List</a>
            </div>

        </div>
        <form action="index.php?act=Update_Category" method="POST" enctype="multipart/form-data">
